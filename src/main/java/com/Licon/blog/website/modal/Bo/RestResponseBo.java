...
public class RestResponseBo<T> {
    ...
    public static RestResponseBo<Boolean> ok() {
        return new RestResponseBo<Boolean>(true);
    }
    ...
    public static RestResponseBo<Boolean> fail() {
        return new RestResponseBo<Boolean>(false);
    }
